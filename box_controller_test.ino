...
ros::Subscriber<std_msgs::Float32> sub("cooler", &cooler_callback) ;
ros::Subscriber<std_msgs::Float32> sub("LED left", &LED_left_callback) ;
ros::Subscriber<std_msgs::Float32> sub("LED right", &LED_right_callback) ;
